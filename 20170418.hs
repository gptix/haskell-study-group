...
-- Below, the commented-out lines are for defining each case.  If measurement of equality works, the seven cases of a DoW matching itself can be compressed. Once all EQ and LT cases are handled, the remainder (as in "compare _ _") are GT.
